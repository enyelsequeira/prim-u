import { Banner, Body, Button, Card, SubTitle, Text, Title } from "./banner.styles";
    ...
    <Banner>
      <Card>
        <Body>
          ...
          <Text>
            With just one click, Prim-U will connect U to the right primlancer, at the right time,
